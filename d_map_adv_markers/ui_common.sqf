...
_whiteList = ["hd_dot", "hd_objective", "hd_flag", "hd_destroy", "hd_end", "hd_pickup", "hd_warning", "hd_unknown", "o_unknown", "o_inf", "swt_sw","sg_complete","o_armor"]; // Список доступных маркеров
