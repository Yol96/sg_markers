...
_whiteList = ["hd_dot", "hd_objective", "hd_flag", "hd_arrow", "hd_ambush", "hd_destroy", "hd_start", "hd_end", "hd_pickup", "hd_join", "hd_warning", "hd_unknown", "o_unknown", "o_inf", "swt_sw", "o_armor"]; // Список доступных маркеров
