TF_FREQ_OFFSET = 2;
TF_FREQ_ROUND_POWER = 100; //округление частот по формуле: _freq = round (_freq * TF_FREQ_ROUND_POWER) / TF_FREQ_ROUND_POWER; // 10 - до 1го знака, 100 - до 2х знаков, 1000 - до 3х знаков и т. д.
